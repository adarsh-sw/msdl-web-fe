...
<div className="overview-header">
  <div class="grid grid-3 gap-30">
    <a href="/latest/tutorials/reader/account" className="card link-card">
      <svg
        stroke="currentColor"
        fill="currentColor"
        stroke-width="0"
    ...
    <a href="/latest/tutorials/creator/create-content/" className="card link-card">
      <svg
        stroke="currentColor"
        fill="currentColor"
        stroke-width="0"
    ...
    <a href="/latest/tutorials/moderator/review-publish/" className="card link-card">
      <svg
        stroke="currentColor"
        fill="currentColor"
        stroke-width="0"
